...
# Yordamchi funksiyalar (nom to'qnashuvlaridan saqlaning)
...
# kanallarni qatorda kiritish mumkin, hozir bitta misol
kanallar = "@Uzvakilov"
if not kanallar:
return True
...
bot.send_video(chat_id, f"https://t.me/{kanal_username}/170", caption="👑 Assalomu alaykum. Kino kodini kiriting:", reply_markup={"inline_keyboard":[[{"text":"🎦 KINOLARNI TOPISH","url":f"https://t.me/{kanal_username}"}]]})
...
try:
# copy_message — pyTelegramBotAPI metodining Python uslubi
...
# result - dict bo'lib qaytgan holatlar bo'lishi mumkin
try:
...
if new_message_id:
bot.send_message(chat_id, f"🚀 Botga yangi kino yuklandi!\n#️⃣ Film kodi: {new_message_id}", reply_markup={"inline_keyboard":[[{"text":"Postni koʻrish","url":f"https://t.me/{kanal_username}/{new_message_id}"}]]})
...
# Polling threadni ishga tushuramiz
